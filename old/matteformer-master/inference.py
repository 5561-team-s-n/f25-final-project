...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='checkpoints/best_model1k.pth', help="path of checkpoint")

    # local
    parser.add_argument('--image-dir', type=str, default='AIM_500_TEST_RESULTS/orig/', help="input image dir")
    parser.add_argument('--mask-dir', type=str, default='AIM_500_TEST_RESULTS/result_alpha/', help="input trimap dir")
    parser.add_argument('--trimap-dir', type=str, default='AIM_500_TEST_RESULTS/trimaps/', help="input trimap dir")
